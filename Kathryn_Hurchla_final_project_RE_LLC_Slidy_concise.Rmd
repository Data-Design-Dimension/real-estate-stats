...
You are recommended to repeat the SQL code to download your own file for analysis with the subsequent R scripts. Move it to a "files" folder in your working directory, i.e. "files/RTT_Summary_Deeds.csv" (I'm inserting R code you may use to do this step below).
...
# For Mac:
dir.create("files")
file.move("~/Downloads/RTT_Summary_Deeds.csv", "files/RTT_Summary_Deeds.csv") 
# For Windows:
# dir.create("files")
# file.move("%userprofile%\Downloads\RTT_Summary_Deeds.csv", "files\RTT_Summary_Deeds.csv") 
...
deeds <- read_csv("files/RTT_Summary_Deeds.csv", na = ".")
